...
7. **No AI attribution in git.** Commit messages and PR descriptions carry no
   session link, no "authored/generated by" line, no co-author trailer. The
   commit author is the repo owner.
